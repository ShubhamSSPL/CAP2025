    ...
    <div className="space-y-6">
      ...
      <Card style={{ backgroundColor: 'var(--color-muted)', borderColor: 'var(--color-border)' }}>
        <CardContent className="pt-6">
          <h3 className="text-sm font-semibold mb-4" style={{ color: 'var(--color-foreground)' }}>Name Details</h3>
      ...
      <Card style={{ backgroundColor: 'var(--color-muted)', borderColor: 'var(--color-border)' }}>
        <CardContent className="pt-6">
          <h3 className="text-sm font-semibold mb-4" style={{ color: 'var(--color-foreground)' }}>Basic Information</h3>
      ...
      <Card style={{ backgroundColor: 'var(--color-muted)', borderColor: 'var(--color-border)' }}>
        <CardContent className="pt-6">
          <h3 className="text-sm font-semibold mb-4" style={{ color: 'var(--color-foreground)' }}>Religion & Caste Details</h3>
          <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
            <div className="space-y-2">
      ...
      <Card style={{ backgroundColor: 'var(--color-muted)', borderColor: 'var(--color-border)' }}>
        <CardContent className="pt-6">
          <h3 className="text-sm font-semibold mb-4" style={{ color: 'var(--color-foreground)' }}>Nationality & Domicile</h3>
          <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
            <div className="space-y-2">
      ...
      <Card style={{ backgroundColor: 'var(--color-muted)', borderColor: 'var(--color-border)' }}>
        <CardContent className="pt-6">
          <h3 className="text-sm font-semibold mb-4" style={{ color: 'var(--color-foreground)' }}>Identity Documents</h3>
          <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
            <div className="space-y-2">
      ...
      <Card style={{ backgroundColor: 'var(--color-muted)', borderColor: 'var(--color-border)' }}>
        <CardContent className="pt-6">
          <h3 className="text-sm font-semibold mb-4" style={{ color: 'var(--color-foreground)' }}>Contact Information</h3>
          <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
            <div className="space-y-2">
