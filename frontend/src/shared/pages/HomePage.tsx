...
export const HomePage: React.FC = () => {
  ...
  return (
    <div className="min-h-screen bg-gray-50 texture-grid">
      {/* Hero Section */}
      <div className="bg-white texture-paper">
          ...
          <div className="text-center mb-12">
            ...
            <div className="flex flex-col sm:flex-row items-center justify-center gap-4 mb-12">
              <button
                ...
                className="px-8 py-4 bg-primary-600 hover:bg-primary-700 text-white font-semibold rounded-lg shadow-md hover:shadow-lg transition-all duration-200 flex items-center gap-3"
              >
              ...
              <button
                ...
                className="px-8 py-4 border-2 border-gray-300 bg-white hover:bg-gray-50 text-gray-700 font-semibold rounded-lg shadow-sm hover:shadow-md transition-all duration-200 flex items-center gap-3"
              >
